...
# <요구사항 1>
    ...
    # <요구사항 2>
    print("\n\n두개의 값 : {0}와 {1} ".format(first, second))
    ...
    if way == 1:
        ...
        print("정수나누기 값 (a // b) : {0} ".format(first // second))
    elif way == 5:
        print("실수나누기 값 (a / b): {0} ".foramat(first / second))
    elif way == 6:
        print("나머지 구하기 값 (a % b) : {0} ".format(first % second))
    elif way == 7:
        print("프로그램을 종료합나디.")
        break
    else:
